...
class CustomDialog {
  Future<dynamic> showWarningDialog(
      {required BuildContext context, required String msg, Function? btnOnPress}) {
  ...
  Future<dynamic> showSuccessDialog(
      {required BuildContext context, required String msg, String? btnMsg, Function? btnOnPress}) {
    return AwesomeDialog(
            headerAnimationLoop: false,
            btnOkColor: Theme.of(context).primaryColor,
            context: context,
